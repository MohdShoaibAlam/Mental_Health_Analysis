...
SELECT * FROM mental_health_care.anxiety_depression_data;
...
min(Self_Esteem_Score),max(Self_Esteem_Score),min(Life_Satisfaction_Score),max(Life_Satisfaction_Score),min(Loneliness_Score),max(Loneliness_Score) from anxiety_depression_data;
